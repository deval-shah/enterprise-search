...
class Eval:
    ...
    def __init__(self, data_path: str, results_file_path: str):
        ...
        self.global_embed_model = setup_global_embed_model(config)
        self.rag_pipeline = Pipeline(tenant_id = "tenant1", config=config, global_embed_model=self.global_embed_model)
...
if __name__ == "__main__":
    ...
    nest_asyncio.apply()
    asyncio.run(main(args.data_path, args.qa_json_path, args.output_file_name, args.limit, args.save))
